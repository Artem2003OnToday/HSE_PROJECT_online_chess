...
chessboard_square::chessboard_square(sf::Vector2f coordinates, std::string file)
{
...
sf::Sprite& chessboard_square::getModel()
{
...
pieces& chessboard_square::getPieceOnSquare()
{
	return *figureOnSquare;
}

bool chessboard_square::isPiece()
{
	return pieceIsHere;
}
...
sf::CircleShape* chessboard_square::getMark()
{
	return this->mark;
}
