...
sf::Sprite &pieces::getPieceMadel() { return *this->pieceSprite; }
...
pieces::operator bool() { return this->team; }

void pieces::nullSpecial() { this->specialMove = false; }

bool pieces::getSpecial() { return this->specialMove; }

int pieces::getPieceType() { return this->type; }

std::vector<sf::Vector2i> pieces::getMovements() { return this->movements; }

pieces::pieces(std::vector<sf::Vector2i> moves, int pieceCost, bool special,
